...
router.post('/', isAuthenticated, authorizeRole(['Administrador', 'Recepción']), tratamientoController.createTratamiento);
router.put('/:id', isAuthenticated, authorizeRole(['Administrador', 'Recepción']), tratamientoController.updateTratamiento); // <-- Línea 9
