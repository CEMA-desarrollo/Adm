...
router.post('/', isAuthenticated, authorizeRole(['Administrador', 'Recepción']), pagoController.createPago);
router.put('/:id', isAuthenticated, authorizeRole(['Administrador', 'Recepción']), pagoController.updatePago);
